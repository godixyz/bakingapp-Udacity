...
import com.movieapp.konwo.bakingapp.BuildConfig;
import com.movieapp.konwo.bakingapp.R;
import com.movieapp.konwo.bakingapp.data.local.provider.IngredientContract;
...
import com.movieapp.konwo.bakingapp.injection.Injection;
import com.movieapp.konwo.bakingapp.presentation.base.BaseActivity;
import com.movieapp.konwo.bakingapp.presentation.recipe_details.RecipeDetailsActivity;
import com.movieapp.konwo.bakingapp.utils.CommonUtils;
import com.movieapp.konwo.bakingapp.widgets.IngredientsWidgetProvider;
...
public class RecipeListActivity extends BaseActivity implements RecipeListContract.View {
    ...
    private void showIngredientsInWidget(int adapterPosition) {
        ...
        Uri uri = IngredientContract.Entry.CONTENT_URI;
        ...
        if (cursor != null) {
            ...
            while (cursor.moveToNext()) {
                getContentResolver().delete(uri,
                        IngredientContract.Entry._ID + "=?",
                        new String[]{
                                cursor.getString(cursor.getColumnIndex(IngredientContract.Entry._ID))}
                );
            }
            ...
            for (int i = 0; i < ingredients.size(); i++) {
                ...
                values[i].put(IngredientContract.Entry.COLUMN_NAME_QUANTITY, ingredients.get(i).getQuantity());
                values[i].put(IngredientContract.Entry.COLUMN_NAME_MEASURE, ingredients.get(i).getMeasure());
                values[i].put(IngredientContract.Entry.COLUMN_NAME_INGREDIENTS, ingredients.get(i).getIngredient());
            }
